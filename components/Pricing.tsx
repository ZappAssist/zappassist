  ...
  const plans = [
    {
      ...
      period: '/mês',
      users: '5 usuários',
      connections: '1 conexão (WhatsApp)',
      features: [
        'WhatsApp integrado',
        'Chatbot inteligente',
        'Kanban de tickets',
    ...
    },
    {
      ...
      period: '/mês',
      users: '8 usuários',
      connections: '2 conexões (WhatsApp, Telegram)',
      features: [
        'WhatsApp + Telegram',
        'Chatbot inteligente',
        'Kanban de tickets',
    ...
    },
    {
      ...
      period: '/mês',
      users: '10 usuários',
      connections: '3 conexões (WhatsApp, Telegram, Facebook)',
      features: [
        'Todas as conexões anteriores + Facebook',
        'Chatbot inteligente',
        'Kanban de tickets',
        'Campanhas avançadas',
        'Hub de integrações',
      ...
      popular: true,
      gradient: 'from-[#9f60fe] to-[#00e4e3]',
      savings: 'Economize R$ 1.200/mês'
    },
    {
      name: 'Diamante',
      price: 'R$ 299,99',
      period: '/mês',
      users: '12 usuários',
      connections: '4 conexões (WhatsApp, Telegram, Facebook, Instagram)',
      features: [
        'Todas as conexões + Instagram',
        'Chatbot inteligente',
        'Kanban de tickets',
        'Campanhas + Hub de integrações',
        'Suporte 24/7',
        'Relatórios premium'
      ],
      popular: false,
      gradient: 'from-purple-600 to-blue-600',
      savings: 'Economize R$ 1.500/mês'
    }
  ];

  const extras = [
    {
      name: 'API Plus WhatsApp',
      price: '+R$ 10',
      description: 'Botões e listas no chatbot',
      icon: 'ri-smartphone-line'
    },
    {
      name: 'API Oficial WhatsApp',
      price: '+R$ 150/mês',
      description: 'Recomendado para alto volume',
      icon: 'ri-verified-badge-line'
    },
    {
      name: 'Instagram/Facebook',
      price: '+R$ 50/conexão',
      description: 'Para planos Bronze/Prata',
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-6">
            Investimento que <span className="bg-gradient-to-r from-[#9f60fe] to-[#00e4e3] bg-clip-text text-transparent">se paga sozinho</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {plans.map((plan, index) => (
            <div key={index} className={`relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 ${plan.popular ? 'border-[#9f60fe] scale-105' : 'border-gray-100 hover:border-gray-200'}`}>
              {plan.popular && (
              ...
              <div className="p-8">
                <div className={`w-20 h-20 bg-gradient-to-r ${plan.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg`}>
                ...
                <Link
                  ...
                  className={`w-full py-4 px-6 rounded-2xl font-bold transition-all whitespace-nowrap cursor-pointer text-center block shadow-lg hover:shadow-xl transform hover:scale-105 duration-300 mb-3 ${plan.popular ? 'bg-gradient-to-r from-[#9f60fe] to-[#00e4e3] text-white' : 'bg-gray-900 text-white hover:bg-gray-800'}`}
                >
                ...
                <Link
                  href={`https://wa.me/5535991217758?text=Quero contratar o plano ${plan.name} por ${plan.price}/mês`}
        ...
        <div className="bg-white rounded-3xl p-12 shadow-xl border border-gray-100 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {extras.map((extra, index) => (
              <div key={index} className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                <div className="w-16 h-16 bg-gradient-to-r from-[#9f60fe] to-[#00e4e3] rounded-xl flex items-center justify-center mb-6">
                  <i className={`${extra.icon} text-white text-2xl`}></i>
                </div>
                <h4 className="font-bold text-gray-900 mb-3 text-xl">{extra.name}</h4>
                <div className="text-3xl font-bold text-[#9f60fe] mb-4">{extra.price}</div>
                <p className="text-gray-600 leading-relaxed">{extra.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex items-start space-x-6">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Os custos dessas integrações externas (como tokens da OpenAI) são de responsabilidade do cliente e pagos diretamente aos fornecedores. Nossa equipe ajuda na configuração sem custos adicionais.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-[#9f60fe] to-[#00e4e3] rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-2 opacity-90">
                Enquanto você pensa, seus concorrentes já estão automatizando e vendendo mais
              </p>
              <p className="text-lg mb-8 opacity-80">
                ⏰ Mais de 50 empresas se cadastraram essa semana
              </p>
